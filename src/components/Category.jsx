...
function Category(props) {
  const categories = [
    ...
    {
      categoryId: 5,
      category: "Máy ảnh và máy quay phim",
    ...
    {
      categoryId: 18,
      category: "Phụ kiện và thời trang nữ",
...
//   const filterResult = (productItem) => {
//     const result = categoryList.filter((currentData) => {
//       return currentData.category === productItem;
//     });
        ...
        <div className="container">
          ...
          <div className="category-list">
            {categories.map((Item, index) => (
              ...
              >
                <Link to={"/categoryitem/" + Item.category}> 
                  <img
